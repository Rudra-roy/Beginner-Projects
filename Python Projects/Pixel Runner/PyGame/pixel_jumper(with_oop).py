...
# With advanced features like OOP, classes, sprites etc.
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super.__init__()
        self.image = pygame.image.load('E:\Game development with Python\PyGame\graphics\Player\player_walk_1.png').convert_alpha()
        self.rect = self.image.get_rect(topleft= (60,220))
    
    def player_input(self):
        keys = pygame.key.get_pressed()
        if keys[K_Return] and self.rect.bottom >= 300:
            self.gravity = -20
